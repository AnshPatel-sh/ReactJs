...
function App() {
  ...
  request going on due to the function asynchronous behaviour so it should not update the state of the component 
  ...
  .. seconds before useEffect re-runs but here it wont happen until the component is re-mounted again 
